...
class make_ir_seq:
    ...
    def gen_c(self, name, fd, hfd, hfilename):
        datums, labels = self.extract()
        cname = tr(name, '/-.', '___')
        chname = tr(hfilename, '/-.', '___')

        h_tpl = '''/* This file is automatically generated. */
